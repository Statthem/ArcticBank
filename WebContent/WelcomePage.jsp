...
<link rel="stylesheet" type="text/css" href="BootStrap/fonts/font-awesome/css/font-awesome.css">
...
<nav id="menu" class="navbar navbar-default navbar-fixed-top">
  <div class="container"> 
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="WelcomePage.html"><i class="fa fa-sun-o"></i> Arctic<strong></strong></a> </div>
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
       ...
       <%} else {%>
        ...
        <input type="submit" value="Log Out" style="">  </form> </li>
          <%}%>
      </ul>
    </div>
    <!-- /.navbar-collapse --> 
...
<header class="text-center" name="home">
  <div class="intro-text">
    <h1>Welcome to<strong> Arctic Bank</strong></h1>
...
<br>
						<input type="submit" value="Login" style="">     not registered? <a href="RegistrationPage.html"> Register here!</a>
...
<div id="services-section" class="text-center">
  <div class="container">
    <div class="section-title center">
      ...
      <p>new Credit card registration</p>
    </div>
    <div class="space"></div>
    <div class="row">
      <div class="col-md-3 col-sm-6 service"> <i class="fa fa-desktop"></i>
        ...
        <p>
        <% if (request.getSession().getAttribute("current_user") != null){ %>
        <a href = "CreditCardRegistration.html">new credit card </a>
        <%}else{ %>
        Only registered users can own Credit card
        <%} %>
        </p>
      </div>
